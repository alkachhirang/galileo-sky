...
const Header = () => {
    ...
    return (
        <div id='header' className='lg:h-[810px] md:h-[720px] sm:h-[640px] h-[600px] 2xl:min-h-screen overflow-x-clip lg:flex lg:flex-col relative bg-black'>
            ...
            <div className="absolute bottom-[3%] z-[4] left-0 right-0 flex items-center justify-center cursor-pointer">               <div
            ...
            >
                <div
                    className={`${toggleScroll ? "translate-y-[110%]" : "translate-y-0"
                        } lg:w-[27px] lg:h-[27px] w-[17px] h-[17px] rounded-full bg-lightRed transition-all ease-linear duration-300`}
                ></div>
            </div>
            </div>
        </div>
