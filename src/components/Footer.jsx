...
//                                 <div className="sm:max-w-[347px] max-w-[500px] flex items-center w-full border border-solid border-offWhite pl-[21px] p-[7px] rounded-[10px]" >
//                                     <input required className="text-base !text-offBlack ff_poppins font-normal outline-none w-full "
//                                         type="text"
...
//                                     )}
//                                     <button className="ff_poppins text-offWhite font-normal text-base rounded-[8px] py-[12px] px-[28px] md:py-[14px] md:px-[32px] bg-darkRed ">submit</button>
//                                 </div>
//                                 {showSuccessPopup && (
